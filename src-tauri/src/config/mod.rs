...
pub use connection::{
    ...
    SerialModemUploadProtocol, SessionsConfig, SftpCwdFollowMode, SftpSettings, SshAgentEndpoint,
    SshAgentForwardingConfig, SshAgentForwardingPolicy, SshAgentForwardingSources,
    SshAlgorithmMode, SshAlgorithmPreferences, SshProfile, SshRuntimeMode, SshTerminalType,
    TelnetAutoLoginConfig, VncClipboardSettings, VncDisplaySettings, VncReconnectSettings,
    VncSecuritySettings, connection_custom_icon_from_data_url,
